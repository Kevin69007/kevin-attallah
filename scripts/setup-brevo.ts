...
<body style="margin:0;padding:0;background-color:${DARK};font-family:'Space Grotesk',Arial,Helvetica,sans-serif;">
<table width="100%" cellpadding="0" cellspacing="0" style="background-color:${DARK};padding:32px 16px;">
<tr><td align="center">
...
<!-- CONTENT CARD -->
<tr><td style="background-color:#FFFFFF;padding:40px 36px;border-radius:0 0 8px 8px;">
...
<tr><td style="padding:28px 24px;text-align:center;">
  <p style="margin:0 0 12px;font-size:13px;color:#999999;font-family:'Space Mono','Courier New',monospace;">
    ${socialLinks}
  </p>
  <p style="margin:0 0 8px;font-size:12px;color:#777777;font-family:'Space Mono','Courier New',monospace;">
    <a href="mailto:${CONTACT_EMAIL}" style="color:${ORANGE};text-decoration:none;">${CONTACT_EMAIL}</a>
  </p>
  <p style="margin:0;font-size:11px;color:#555555;font-family:'Space Mono','Courier New',monospace;">
